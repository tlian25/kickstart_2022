...
abs(#R - #B) <= 1 # move counts must be within one of each other

Winner must have 1 more move than loser on board

Conduct a BFS from each cell on top edge to see if Blue won

Conduct a BFS from each cell on left edge to see if Red won
